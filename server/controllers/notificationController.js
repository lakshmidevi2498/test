...
export const notificationPostController = async (req, res) => {
  try {
      ...
      let existingSubscription = await notificationSchema.findOne({ endpoint: subscription.endpoint, token: token });
      ...
      if (existingSubscription) {
          ...
          const newSubscription = new notificationSchema({
              ...subscription, // Spread the subscription properties
              token,            // Add token to the subscription data
          });
